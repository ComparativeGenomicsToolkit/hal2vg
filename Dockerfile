...
# autoconf is needed to build the vendored jemalloc
RUN apt-get -qq update && apt-get -qq install -y libhdf5-dev build-essential python3-dev python3-pip cmake libz-dev pkg-config git autoconf
